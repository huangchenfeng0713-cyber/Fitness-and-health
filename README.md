...
```bash
npm test               # node --test，92 个用例，覆盖营养计算 / 建议引擎 / 健康数据解析 / 健康解读 / 食物库自洽性
```
...
内置 504 种中国常见食物，覆盖家常菜、日常外卖（黄焖鸡米饭、水煮肉片、螺蛳粉、麻辣香锅……）、
早餐面点、火锅烧烤、便利店食品、常见果蔬菌菇，以及 **55 种连锁快餐单品**：
肯德基、麦当劳、汉堡王、德克士、塔斯汀、华莱士、必胜客、赛百味、星巴克、瑞幸、
蜜雪冰城、喜茶、茶百道、霸王茶姬、老乡鸡、沙县小吃、萨莉亚、和府捞面、吉野家。
