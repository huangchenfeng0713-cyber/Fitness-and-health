...
当前版本：**v3.17.1**（快捷指令同步的每日消耗重新参与计算；挑选弹层里的下拉不再自己弹第二次；底栏收起时正文不再贴着屏幕底；空计划也答「今天练什么」）
...
内置 1219 种常见食物（含 284 道菜肴、208 项连锁快餐），并能按基础食材生成受控的家常组合菜；覆盖家常菜、日常外卖（黄焖鸡米饭、水煮肉片、螺蛳粉、麻辣香锅……）、
